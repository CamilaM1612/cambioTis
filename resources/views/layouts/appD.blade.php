...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="{{ route('recursos.index') }}" class="selected"> <!-- Cambiado a "Contenido de la materia" -->
                <div class="option">
                    <i class="bi bi-book"></i> <!-- Icono de contenido de materia -->
            ...
            <a href="{{ route('grupos.index') }}" class="selected"> <!-- Cambiado a "Contenido de la materia" -->
                <div class="option">
                    <i class="bi bi-book"></i> <!-- Icono de contenido de materia -->
