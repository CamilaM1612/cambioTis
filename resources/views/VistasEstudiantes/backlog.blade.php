                ...
                <div class="col-md-12 mb-4">
                    ...
                    <div class="d-flex flex-column p-3 border rounded-3 shadow-sm">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            <button class="btn btn-link text-secondary" type="button" data-bs-toggle="collapse"
                                data-bs-target="#subtareas{{ $historia->id }}" aria-expanded="false"
                                aria-controls="subtareas{{ $historia->id }}">
                        ...
                        <div class="modal fade" id="modalSubtarea{{ $historia->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalSubtareaLabel{{ $historia->id }}">Crear Subtarea
                                ...
                                <div class="collapse mt-3" id="subtareas{{ $historia->id }}">
                                    <ul class="list-group">
                                        @foreach ($historia->subtareas as $subtarea)
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    @if ($subtarea->miembroAsignado)
                                                        <p class="mt-2"><strong>Miembro Asignado:</strong>
                                                            {{ $subtarea->miembroAsignado->name }}</p>
                                                    @else
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <!-- Botón para Eliminar -->
                                                    <form action="{{ route('subtareas.destroy', $subtarea->id) }}"
                                            ...
                                            <div class="modal fade" id="editarSubtareaModal{{ $subtarea->id }}"
                                                tabindex="-1"
                                                aria-labelledby="editarSubtareaModalLabel{{ $subtarea->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="editarSubtareaModalLabel{{ $subtarea->id }}">Editar
                                                                Subtarea: {{ $subtarea->titulo }}</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('subtareas.update', $subtarea->id) }}"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="miembro_asignado"
                                                                        class="form-label">Miembro Asignado</label>
                                                                    <select class="form-control" id="miembro_asignado"
