                        ...
                        <tbody>
                            @foreach ($proyecto->sprints as $index => $sprint)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <a href="{{ route('historias.show', $sprint->id) }}" class="text-decoration-none">
                                                {{ $sprint->nombre }}
                                            </a>
