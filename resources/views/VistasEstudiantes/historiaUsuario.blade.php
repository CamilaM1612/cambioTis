...
<div class="row">
    @foreach ($historias as $historia)
        <div class="col-md-4 mb-4">
            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editHistoriaModal{{ $historia->id }}" title="Editar">
        ...
        <div class="modal fade" id="editHistoriaModal{{ $historia->id }}" tabindex="-1" aria-labelledby="editHistoriaModalLabel{{ $historia->id }}" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editHistoriaModalLabel{{ $historia->id }}">Editar Historia de Usuario</h5>
...
<div class="modal fade" id="createHistoriaModal" tabindex="-1" aria-labelledby="createHistoriaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('historias.store', $equipo->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
            <label for="descripcion" class="form-label">Descripción</label>
            <textarea name="descripcion" id="descripcion" class="form-control" rows="4" required>Yo como [rol], quiero [acción o funcionalidad], para [beneficio o propósito].
</textarea>
        </div>
                    <div class="mb-3">
                        <label for="prioridad" class="form-label">Prioridad</label>
